...
public class QuestCommandCleanupQuestLine extends QuestCommandBase {
    ...
    @Override
    public String getCommand() { return "cleanup_questline"; }

    @Override
    public String getPermissionNode() { return "betterquesting.command.admin.cleanup_invalid_quests"; }

    @Override
    public DefaultPermissionLevel getPermissionLevel() { return DefaultPermissionLevel.OP; }

    @Override
    public String getPermissionDescription() { return "Permission to purge quests with invalid dependencies"; }
            ...
            synchronized (QuestDatabase.INSTANCE) {
                for (DBEntry<IQuestLine> questLineDBEntry : QuestLineDatabase.INSTANCE.getEntries()) {
                    ...
                    for (DBEntry<IQuestLineEntry> questLineEntryDBEntry : questLine.getEntries()) {
                        ...
                        if (quest == null) {
                            removed++;
                            BetterQuesting.logger.info("Removed QuestLineEntry {} in QuestLine {} pointing into nonexistent quest {}",
