...
public class PanelTaskAdvancement extends CanvasEmpty {
    ...
    public void initPanel() {
        ...
        overlay.setCompleted(isComplete);
        this.addPanel(overlay);

        this.addPanel(new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(28, 2, 0, -12), 0), title).setColor(PresetColor.TEXT_MAIN
                .getColor()));
        String s = isComplete ? (TextFormatting.GREEN.toString() + QuestTranslation.translate("betterquesting.tooltip.complete")) : (TextFormatting.RED
                .toString() + QuestTranslation.translate("betterquesting.tooltip.incomplete"));
