...
public class GuiDesigner extends GuiScreenCanvas implements IVolatileScreen, INeedsRefresh, IPEventListener {
    ...
    public void initPanel() {
        ...
        PanelGeneric pnFrame = new PanelGeneric(new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(16, 16, 16, 16), 0),
        ...
        PanelButton btnTabLeft = new PanelButton(
                new GuiTransform(new Vector4f(0F, 0F, 0.5F, 0F), new GuiPadding(16, 32, 0, -40), 0), 2, "") {
        ...
        PanelButton btnTabRight = new PanelButton(
                new GuiTransform(new Vector4f(0.5F, 0F, 1F, 0F), new GuiPadding(0, 32, 16, -40), 0), 3, "") {
        ...
        tabTitle = new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(16, 20, 16, -32), 0), "?")
                .setAlignment(1).setColor(PresetColor.TEXT_HEADER.getColor());
        ...
        if (toolController != null) {
            ...
            toolController = new PanelToolController(
                    new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(16, 16, 16, 16), -1), cvQuest);
            cvBackground.addPanel(toolController);
            cvQuest.setScrollDriverX(toolController.getScrollX());
            cvQuest.setScrollDriverY(toolController.getScrollY());
            cvQuest.fitToWindow();
    ...
    private void refreshToolTab() {
        ...
        lastTabPanel = tabList.get(tabIdx).getTabGui(
                new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(16, 48, 16, 16), 0), cvQuest, toolController);
