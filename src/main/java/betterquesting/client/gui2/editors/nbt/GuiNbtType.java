...
public class GuiNbtType extends GuiScreenCanvas implements IPEventListener, IVolatileScreen {
    ...
    public void initPanel() {
        ...
        PanelTextBox panTxt = new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 16, 0, -32), 0),
                QuestTranslation.translate("betterquesting.title.json_object")).setAlignment(1);
        ...
        cvBackground.addPanel(new PanelButton(new GuiTransform(GuiAlign.MID_CENTER, -100, -16, 200, 16, 0), 2,
                QuestTranslation.translate("betterquesting.btn.item")));
        cvBackground.addPanel(new PanelButton(new GuiTransform(GuiAlign.MID_CENTER, -100, 0, 200, 16, 0), 3,
                QuestTranslation.translate("betterquesting.btn.fluid")));
        cvBackground.addPanel(new PanelButton(new GuiTransform(GuiAlign.MID_CENTER, -100, 16, 200, 16, 0), 4,
