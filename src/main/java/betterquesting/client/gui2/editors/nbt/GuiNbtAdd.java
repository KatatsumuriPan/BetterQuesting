...
public class GuiNbtAdd extends GuiScreenCanvas implements IPEventListener, IVolatileScreen {
    ...
    public void initPanel() {
        ...
        btnConfirm = new PanelButton(new GuiTransform(GuiAlign.BOTTOM_CENTER, 0, -16, 100, 16, 0), 1,
        ...
        if (nbt.getId() == 10) // NBTTagCompound
        {
            ...
            PanelTextBox txKeyTitle = new PanelTextBox(new GuiTransform(GuiAlign.TOP_CENTER, -100, 36, 200, 12, 0),
                    TextFormatting.RED + QuestTranslation.translate("betterquesting.gui.no_key"));
            txKeyTitle.setColor(PresetColor.TEXT_MAIN.getColor());
            cvBackground.addPanel(txKeyTitle);

            flKey = new PanelTextField<>(new GuiTransform(GuiAlign.TOP_CENTER, -100, 48, 200, 16, 0), "",
            ...
            flKey.setCallback(value -> {
                if (value.isEmpty()) {
                    ...
                    txKeyTitle.setText(
                            TextFormatting.RED + QuestTranslation.translate("betterquesting.gui.duplicate_key"));
                } else {
        ...
        // Standard Objects
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n * 16, 100, 16, 0), 2,
        ...
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                QuestTranslation.translate("betterquesting.btn.entity"),
                JsonHelper.EntityToJson(new EntityPig(mc.world), new NBTTagCompound())));

        // NBT types
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagString.class.getSimpleName(), new NBTTagString("")));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagCompound.class.getSimpleName(), new NBTTagCompound()));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagList.class.getSimpleName(), new NBTTagList()));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagByte.class.getSimpleName(), new NBTTagByte((byte) 0)));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagShort.class.getSimpleName(), new NBTTagShort((short) 0)));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagInt.class.getSimpleName(), new NBTTagInt(0)));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagLong.class.getSimpleName(), new NBTTagLong(0L)));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagFloat.class.getSimpleName(), new NBTTagFloat(0F)));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagDouble.class.getSimpleName(), new NBTTagDouble(0D)));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagByteArray.class.getSimpleName(), new NBTTagByteArray(new byte[0])));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n++ * 16, 192, 16, 0), 2,
                NBTTagIntArray.class.getSimpleName(), new NBTTagIntArray(new int[0])));
        options.add(new PanelButtonStorage<>(new GuiTransform(GuiAlign.MID_CENTER, 0, n * 16, 192, 16, 0), 2,
                NBTTagLongArray.class.getSimpleName(), new NBTTagLongArray(new long[0])));

        CanvasScrolling cvOptions = new CanvasScrolling(
                new GuiTransform(new Vector4f(0.5F, 0F, 0.5F, 1F), new GuiPadding(-100, 64, -92, 32), 0));
        ...
        PanelVScrollBar scOptions = new PanelVScrollBar(
                new GuiTransform(new Vector4f(0.5F, 0F, 0.5F, 1F), new GuiPadding(92, 64, -100, 32), 0));
