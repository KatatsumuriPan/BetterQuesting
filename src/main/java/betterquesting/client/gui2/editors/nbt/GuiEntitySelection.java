...
public class GuiEntitySelection extends GuiScreenCanvas implements IPEventListener, IVolatileScreen {
    ...
    public void initPanel() {
        ...
        CanvasEntityDatabase cvDatabase = new CanvasEntityDatabase(
        ...
        pnPreview = new PanelEntityPreview(new GuiTransform(GuiAlign.HALF_LEFT, new GuiPadding(16, 32, 8, 32), 0),
                selEntity);
        cvBackground.addPanel(pnPreview);

        pnPreview.setRotationDriven(new ValueFuncIO<>(() -> 15F),
