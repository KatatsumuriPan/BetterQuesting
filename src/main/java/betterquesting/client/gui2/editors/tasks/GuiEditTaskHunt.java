...
public class GuiEditTaskHunt extends GuiScreenCanvas implements IVolatileScreen {
    ...
    public void initPanel() {
        ...
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, 0, 0, 100, 16, 0),
                "" + task.required, FieldFilterNumber.INT).setCallback(value -> task.required = value));
        ...
        cvBackground.addPanel(new PanelButton(new GuiTransform(GuiAlign.MID_CENTER, -100, 16, 200, 16, 0), -1,
            ...
            public void onButtonClick() {
                mc.displayGuiScreen(QuestingAPI.getAPI(ApiReference.THEME_REG).getGui(PresetGUIs.EDIT_ENTITY,
                        new GArgsCallback<>(screenRef, target, value -> {
