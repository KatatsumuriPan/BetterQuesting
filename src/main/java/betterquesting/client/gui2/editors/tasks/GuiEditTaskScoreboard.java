...
public class GuiEditTaskScoreboard extends GuiScreenCanvas {
    ...
    public void initPanel() {
        ...
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, -50, -32, 150, 16, 0), task.scoreDisp, FieldFilterString.INSTANCE)
                .setCallback(value -> task.scoreDisp = value));
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, -50, -16, 150, 16, 0), task.scoreName, FieldFilterString.INSTANCE)
                .setCallback(value -> task.scoreName = value));

        cvBackground.addPanel(new PanelButtonStorage<ScoreOperation>(new GuiTransform(GuiAlign.MID_CENTER, -100, 0, 50, 16, 0),
                                                                     -1,
        ...
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, -50, 0, 150, 16, 0), "" + task.target, FieldFilterNumber.INT)
