...
public class GuiEditTaskScoreboard extends GuiScreenCanvas {
    ...
    public void initPanel() {
        ...
        cvBackground.addPanel(new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(16, 16, 16, -32), 0),
                QuestTranslation.translate("bq_standard.title.edit_scoreboard")).setAlignment(1)
        ...
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, -50, -32, 150, 16, 0),
                task.scoreDisp, FieldFilterString.INSTANCE).setCallback(value -> task.scoreDisp = value));
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, -50, -16, 150, 16, 0),
                task.scoreName, FieldFilterString.INSTANCE).setCallback(value -> task.scoreName = value));
        ...
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, -50, 0, 150, 16, 0),
                "" + task.target, FieldFilterNumber.INT).setCallback(value -> task.target = value));
        ...
        cvBackground.addPanel(new PanelButton(new GuiTransform(GuiAlign.MID_CENTER, -100, 16, 200, 16, 0), -1,
            ...
            public void onButtonClick() {
                mc.displayGuiScreen(QuestingAPI.getAPI(ApiReference.THEME_REG).getGui(PresetGUIs.EDIT_NBT,
                        new GArgsNBT<>(screenRef, task.writeToNBT(new NBTTagCompound()), task::readFromNBT, null)));
            }
        });
    ...
    private static final ResourceLocation QUEST_EDIT = new ResourceLocation(ModReference.MODID, "quest_edit");
