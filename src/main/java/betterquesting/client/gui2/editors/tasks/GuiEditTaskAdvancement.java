...
public class GuiEditTaskAdvancement extends GuiScreenCanvas implements IVolatileScreen {
    ...
    public void initPanel() {
        ...
        CanvasAdvancementSearch cvAdvList = new CanvasAdvancementSearch(
                new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(16, 48, 24, 24), 0),
            ...
            protected boolean addResult(Advancement entry, int index, int cachedWidth) {
                ...
                this.addPanel(new PanelGeneric(new GuiRectangle(0, index * 24, 24, 24, 0),
                ...
                PanelButtonStorage<Advancement> btnAdv = new PanelButtonStorage<>(
                        new GuiRectangle(24, index * 24, cachedWidth - 24, 24, 0), -1,
                        disp != null ? disp.getTitle().getFormattedText() : entry.getId().toString(), entry);
        ...
        PanelVScrollBar scAdv = new PanelVScrollBar(
        ...
        PanelTextField<String> tfSearch = new PanelTextField<>(
                new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(16, 32, 16, -48), 0), "",
