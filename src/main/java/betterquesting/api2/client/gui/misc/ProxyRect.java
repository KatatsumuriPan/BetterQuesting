...
public class ProxyRect implements IGuiRect {
    ...
    @Override
    public int getX() { return ref != null ? ref.getX() : 0; }

    @Override
    public int getY() { return ref != null ? ref.getY() : 0; }

    @Override
    public int getWidth() { return ref != null ? ref.getWidth() : 0; }

    @Override
    public int getHeight() { return ref != null ? ref.getHeight() : 0; }

    @Override
    public int getDepth() { return ref != null ? ref.getDepth() : 0; }

    @Override
    public IGuiRect getParent() { return ref != null ? ref.getParent() : null; }
