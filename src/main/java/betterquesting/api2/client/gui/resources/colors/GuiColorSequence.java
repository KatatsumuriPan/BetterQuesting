...
public class GuiColorSequence implements IGuiColor {
    ...
    @Override
    public int getRGB() { return getCurrentColor().getRGB(); }

    @Override
    public float getRed() { return getCurrentColor().getRed(); }

    @Override
    public float getGreen() { return getCurrentColor().getGreen(); }

    @Override
    public float getBlue() { return getCurrentColor().getBlue(); }

    @Override
    public float getAlpha() { return getCurrentColor().getAlpha(); }
    ...
    public IGuiColor[] getAllColors() { return this.colors; }
