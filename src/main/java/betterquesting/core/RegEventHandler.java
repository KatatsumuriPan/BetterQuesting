...
public class RegEventHandler {
    ...
    public static void initRecipes() {
        addShapelessRecipe("submit_station",
                           "questing",
                           new ItemStack(BetterQuesting.submitStation),
                           new ItemStack(Items.BOOK),
                           new ItemStack(Blocks.GLASS),
                           new ItemStack(Blocks.CHEST));

        addShapelessRecipe("life_full_0",
                           "questing",
                           new ItemStack(BetterQuesting.extraLife, 1, 0),
                           new ItemStack(BetterQuesting.extraLife, 1, 2),
                           new ItemStack(BetterQuesting.extraLife, 1, 2),
                           new ItemStack(BetterQuesting.extraLife, 1, 2),
                           new ItemStack(BetterQuesting.extraLife, 1, 2));
        addShapelessRecipe("life_full_1",
                           "questing",
                           new ItemStack(BetterQuesting.extraLife, 1, 0),
                           new ItemStack(BetterQuesting.extraLife, 1, 2),
                           new ItemStack(BetterQuesting.extraLife, 1, 2),
                           new ItemStack(BetterQuesting.extraLife, 1, 1));
        addShapelessRecipe("life_full_2",
                           "questing",
                           new ItemStack(BetterQuesting.extraLife, 1, 0),
                           new ItemStack(BetterQuesting.extraLife, 1, 1),
                           new ItemStack(BetterQuesting.extraLife, 1, 1));
        ...
        addShapelessRecipe("life_half_1",
                           "questing",
                           new ItemStack(BetterQuesting.extraLife, 1, 1),
                           new ItemStack(BetterQuesting.extraLife, 1, 2),
                           new ItemStack(BetterQuesting.extraLife, 1, 2));
